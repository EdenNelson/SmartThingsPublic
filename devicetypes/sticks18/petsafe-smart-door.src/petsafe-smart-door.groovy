...
metadata {
	...
	tiles {
		standardTile("toggle", "device.lock", width: 3, height: 2) {
			...
			state "automatic", label:'automatic', action:"lock.lock", icon:"st.locks.lock.unlocked", backgroundColor:"#ffff00", nextState:"locking"
			state "unlocked", label:'unlocked', action:"lock.unlock", icon:"st.locks.lock.unlocked", backgroundColor:"#79b821", nextState:"locking"
		...
		standardTile("unlock", "device.lock", inactiveLabel: false, decoration: "flat") {
			state "default", label:'automatic', action:"lock.unlock", icon:"st.locks.lock.unlocked", nextState:"locking"
		}
		standardTile("unlock", "device.lock", inactiveLabel: false, decoration: "flat") {
		...
		main "toggle"
		details(["toggle", "lock", "automatic", "unlock", "battery", "refresh"])
	}
}
